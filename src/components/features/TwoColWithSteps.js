            ...
            <Steps>
              {steps.map((step, index) => (
                <Step key={`${index}-${step.number}`}>
                  ...
                  {/*{*/}
                  {/*  step.children?.length > 0 && step.children.map((child, index) => (*/}
                  {/*    <Step key={`${index}-${child.number}`}>*/}
                  {/*      <StepNumber>{ child.number ?? (index+1).toString().padStart(2,'0')}</StepNumber>*/}
                  {/*      <StepText>*/}
                  {/*        {*/}
                  {/*          child.heading && (*/}
                  {/*            <StepHeading>{step.heading}</StepHeading>*/}
                  {/*          )*/}
                  {/*        }*/}
                  {/*        <StepDescription>{child.description}</StepDescription>*/}
                  {/*      </StepText>*/}
                  {/*    </Step>*/}
                  {/*  ))*/}
                  {/*}*/}
